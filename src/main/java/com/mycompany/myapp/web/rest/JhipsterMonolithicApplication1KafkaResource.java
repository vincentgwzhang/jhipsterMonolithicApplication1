...
@RestController
@RequestMapping("/api/jhipster-monolithic-application-1-kafka")
public class JhipsterMonolithicApplication1KafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterMonolithicApplication1KafkaResource.class);
    ...
    public JhipsterMonolithicApplication1KafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
